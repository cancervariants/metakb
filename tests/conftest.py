...
def moa_vid71():
    ...
    return {
        ...
        "variation": {
            ...
            "state": {"sequence": "I", "type": "LiteralSequenceExpression"},
            "type": "Allele",
        },
        "extensions": [
            {
...
def pmid_11423618():
    ...
    return {
        ...
        "xrefs": ["doi:10.1126/science.1062538"],
        "type": "Document",
    }
        ...
        "extensions": [
            {
                ...
                "value": {
                    "level": "LEVEL_Fda2",
                    "description": "Cancer Mutations with Evidence of Clinical Significance",
                },
            }
        ],
    }
...
def oncokb_braf_v600e_vd():
    ...
    return {
        ...
        "extensions": [
            {"type": "Extension", "name": "oncogenic", "value": "Oncogenic"},
            {
                "type": "Extension",
            ...
            {"type": "Extension", "name": "hotspot", "value": True},
            {"type": "Extension", "name": "vus", "value": False},
            {
                "type": "Extension",
            ...
            {"type": "Extension", "name": "allele_exist", "value": True},
        ],
    }
...
def oncokb_braf_gene_descriptor():
    ...
    return {
        ...
        "label": "BRAF",
        "gene_id": "hgnc:1097",
        "description": "BRAF, an intracellular kinase, is frequently mutated in melanoma, thyroid and lung cancers among others.",
        "xrefs": ["ncbigene:673"],
        "extensions": [
            {
                "type": "Extension",
            ...
            {"type": "Extension", "name": "oncogene", "value": True},
            {
                "type": "Extension",
                "name": "oncokb_highest_sensitive_level",
                "value": "1",
            ...
            {"type": "Extension", "name": "tumor_suppressor_gene", "value": False},
        ],
    }
        ...
        "extensions": [
            {
                ...
                "value": {"id": None, "name": "Histiocytosis", "tumor_form": "LIQUID"},
            },
            {"type": "Extension", "name": "tissue", "value": "Myeloid"},
            {"type": "Extension", "name": "parent", "value": "HDCN"},
            {"type": "Extension", "name": "level", "value": 4},
            {"type": "Extension", "name": "tumor_form", "value": "LIQUID"},
        ],
    }
        ...
        "extensions": [
            {
                "type": "Extension",
                "name": "oncotree_main_type",
                "value": {"id": None, "name": "Melanoma", "tumor_form": "SOLID"},
            },
            {"type": "Extension", "name": "tissue", "value": "Skin"},
            {"type": "Extension", "name": "parent", "value": "SKIN"},
            {"type": "Extension", "name": "level", "value": 2},
            {"type": "Extension", "name": "tumor_form", "value": "SOLID"},
        ],
    }
...
def oncokb_diagnostic1_documents():
    ...
    return [
        {"id": "pmid:25422482", "label": "PubMed 25422482", "type": "Document"},
        {"id": "pmid:26637772", "label": "PubMed 26637772", "type": "Document"},
    ]
...
def oncokb_therapeutic1_documents_query():
    ...
    """
    return [
        {"id": "pmid:29361468", "label": "PubMed 29361468", "type": "Document"},
        {"id": "pmid:25399551", "label": "PubMed 25399551", "type": "Document"},
        {
            "id": "pmid:22663011",
            "label": "Flaherty et al., 2012, N. Engl. J. Med.",
            "description": "Improved survival with MEK inhibition in BRAF-mutated melanoma.",
            "type": "Document",
        },
        {"id": "pmid:25265492", "label": "PubMed 25265492", "type": "Document"},
    ]
                ...
                for test_extension in test["extensions"]:
                    for actual_extension in actual["extensions"]:
                        if test_extension["name"] == actual_extension["name"]:
                            if test_extension["name"] != "civic_actionability_score":
        ...
        for key in test_keys:
            if key in ["alternate_labels", "xrefs"]:
                ...
                if test["type"] == "TherapyDescriptor":
                    ...
                    assert (
                        actual_ext["value"]["approval_rating"]
                        == test_ext["value"]["approval_rating"]
                    )
                    assert len(actual_ext["value"]["has_indications"]) == len(
                        test_ext["value"]["has_indications"]
                    )
...
def check_transformed_cdm():
    ...
    def check_transformed_cdm(
        ...
        if therapy_descriptors:
            tests += (
                (data["therapy_descriptors"], therapy_descriptors, check_descriptor),
            )
