...
@pytest.fixture(scope="module")
def oncokb_propositions(
    oncokb_diagnostic_proposition1, oncokb_therapeutic_proposition1
):
...
def oncokb_therapeutic1_documents():
    ...
    return [
        ...
        {"id": "pmid:22663011", "label": "PubMed 22663011", "type": "Document"},
...
def test_oncokb_transform(
    ...
    oncokb_statements,
    oncokb_propositions,
    oncokb_variation_descriptors,
    oncokb_gene_descriptors,
    oncokb_disease_descriptors,
    oncokb_therapy_descriptors,
    oncokb_methods,
    oncokb_documents,
    check_statement,
    check_proposition,
