        ...
        "drugs": [
            {
                ...
                "aliases": [
                    ...
                    "Mekinist", "MEK Inhibitor GSK1120212", "JTP-74057", "GSK1120212"]
            }, {
                "id": 22,
                "name": "Dabrafenib",
                "ncit_id": "C82386",
                "aliases": ["GSK2118436", "GSK-2118436A", "GSK-2118436", "BRAF Inhibitor GSK2118436",
...
def test_evidence_json(lnscc):
    for ev in civic.evidence:
        if ev['id'] == 3017:
            actual = ev
            break
