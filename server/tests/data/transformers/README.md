...
* **base_construct_statements_input.json**: contains source statement examples that have been produced by the transformers, but may or may not successfully normalize into MetaKB aggregations. Use as input to `Base._upsert_assertion_from_evidence()`
