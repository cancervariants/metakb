...
@pytest.fixture(scope="session")
def civic_eid1462_studystatement():
    """Study statement/evidence item fixture that has TherapyGroup with "OR" operator instead of simple Drug"""
    return {
        "id": "civic.eid:1462",
        "type": "Statement",
        ...
        "proposition": {
            ...
            "subjectVariant": {
                ...
                "aliases": ["LYS601GLU"],
                "extensions": [
                    {"name": "CIViC Molecular Profile Score", "value": 3.0},
                    {
                        "name": "CIViC representative coordinate",
                        "value": {
                            "ensembl_version": 75,
                ...
                "members": [
                    {
                        "id": "ga4gh:VA.QBzDppTSfE4HkmfH3_KOtwLG6bkJHScv",
                        "type": "Allele",
                        "name": "NM_004333.4:c.1801A>G",
                        "digest": "QBzDppTSfE4HkmfH3_KOtwLG6bkJHScv",
                        "expressions": [
                            {"syntax": "hgvs.c", "value": "NM_004333.4:c.1801A>G"}
                        ],
                        "location": {
                            "id": "ga4gh:SL.LtMCqV9gPWn-37WBVGadiScDl-VUfrKp",
                            "type": "SequenceLocation",
                            "digest": "LtMCqV9gPWn-37WBVGadiScDl-VUfrKp",
                            "sequenceReference": {
                                "type": "SequenceReference",
                                "refgetAccession": "SQ.aKMPEJgmlZXt_F6gRY5cUG3THH2n-GUa",
                            },
                    ...
                    {
                        "id": "ga4gh:VA.BYTO_zRgd1SRiEaE4c4DuTqhM8r-ipRP",
                        "type": "Allele",
                        "name": "NC_000007.13:g.140453134T>C",
                        "digest": "BYTO_zRgd1SRiEaE4c4DuTqhM8r-ipRP",
                        "expressions": [
                            {"syntax": "hgvs.g", "value": "NC_000007.13:g.140453134T>C"}
                        ],
                        "location": {
                            "id": "ga4gh:SL.GaEseib-holVtlKii64s4OF95jZ3DRUE",
                            "type": "SequenceLocation",
                            "digest": "GaEseib-holVtlKii64s4OF95jZ3DRUE",
                            "sequenceReference": {
                                "type": "SequenceReference",
                                "refgetAccession": "SQ.F-LrLMe1SRpfUZHkQmvkVKFEGaoDeHul",
                            },
                ...
                "constraints": [
                    {
                        "type": "DefiningAlleleConstraint",
                        "allele": {
                            "id": "ga4gh:VA.XRWGe8uqJAtKogVsF7P6jH8Cn_pjl8mu",
                            "type": "Allele",
                            "name": "K601E",
                            "digest": "XRWGe8uqJAtKogVsF7P6jH8Cn_pjl8mu",
                            "expressions": [
                                {"syntax": "hgvs.c", "value": "NM_004333.4:c.1801A>G"},
                                {
                                    "syntax": "hgvs.p",
                                    "value": "NP_004324.2:p.Lys601Glu",
                                },
                                {
                                    "syntax": "hgvs.g",
                                    "value": "NC_000007.13:g.140453134T>C",
                                },
                                {
                                    "syntax": "hgvs.c",
                                    "value": "ENST00000288602.6:c.1801A>G",
                                },
                            ],
                            "location": {
                                "id": "ga4gh:SL._IKQ8NkRLqHME4cvOSRAxIViiAjQtkiW",
                                "type": "SequenceLocation",
                                "digest": "_IKQ8NkRLqHME4cvOSRAxIViiAjQtkiW",
                                "sequenceReference": {
                                    "type": "SequenceReference",
                                    "refgetAccession": "SQ.cQvw4UsHHRRlogxbWCB8W-mKD4AraM9y",
                                },
            ...
            "predicate": "predictsSensitivityTo",
            "objectTherapeutic": {
                "id": "civic.tsgid:tWJleGyed3g0Eqv1ASxYxVix6lJUtxhw",
                "therapies": [
                    {
                        "id": "civic.tid:4",
                        "extensions": [
                                ...
                                "value": {
                                    ...
                                    "has_indications": [
                                        ...
                                        },
                                        {
                                            "id": "hemonc:61937",
                                            "conceptType": "Disease",
                                            "name": "Low-grade glioma pediatric",
                                        },
                                        {
                                            "id": "hemonc:675",
                                            "conceptType": "Disease",
