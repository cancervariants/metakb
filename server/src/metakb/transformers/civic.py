...
class CivicTransformer(Transformer):
    ...
    async def transform(self) -> None:
        ...
        Updated records will store results in ``processed_data`` instance variable.
        """
    ...
    async def _get_updated_proposition(
        ...
        async def _add_therapy(therapy: CivicGksTherapy) -> MappableConcept:
            """Create therapy given CIViC therapy.

            Attempt to transform. Will add CIViC therapy ID to ``processed_data.therapies``
    ...
    async def _resolve_condition_set(self, condition_set: ConditionSet) -> ConditionSet:
        ...
        Conditions will be added to the ``processed_data.conditions`` variable
