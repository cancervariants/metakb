  ...
  return (
    <DocsLayout>
      ...
      <Typography component="p" sx={{ mb: 2 }}>
        ...
        standards, and biomedical data harmonization. While there is not yet a dedicated MetaKB Jr
        publication, this project extends concepts and infrastructure developed through our previous
        work. Publications, technical details, and related resources will be added here as the
        project evolves.
      </Typography>
