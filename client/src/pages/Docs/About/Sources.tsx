...
<Stack spacing={3} sx={{ mt: 3 }}>
  ...
  <Box>
    ...
    <Typography variant="body2" sx={{ mt: 1 }}>
      Griffith M, Spies NC, Krysiak K, et al. CIViC is a
      community knowledgebase for expert crowdsourcing the
  ...
  <Box>
    ...
    <Typography variant="body2" sx={{ mt: 1 }}>
      Reardon B, Moore ND, Moore NS, et al.
      Integrating molecular profiles into clinical frameworks
      through the Molecular Oncology Almanac.
  ...
  <Box>
    ...
    <Typography variant="body2" sx={{ mt: 1 }}>
      U.S. Food and Drug Administration. FDA-approved oncology
      therapies and pediatric indication resources.
    </Typography>
  </Box>
