...
from metakb.schemas import SearchIDService, SearchService, SearchStatementsService
...
search_summary = (
    "Given variation, disease, therapy, and/or gene, "
    "return associated statements and propositions."
)
search_response_description = "A response to a validly-formed query."
search_description = (
    "Return statements and propositions associated" " to the queried concepts."
)
...
search_statements_descr = "Return nested statements associated to the queried concepts."
...
id_query_desc = (
    "Given Meta-KB statement_id, proposition_id, descriptor_id,"
